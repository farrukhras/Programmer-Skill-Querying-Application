...
func main() {
	...
	var MONGO_URL = "mongodb+srv://farrukhrasool112:Zest1214@cluster0.idswfys.mongodb.net/?retryWrites=true&w=majority"
	...
	router.PUT("/users/update/:id", handlers.UpdateUser(client))
